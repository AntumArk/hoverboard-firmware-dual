...
#define TIMER_SLAVEMODE_GATED            TIMER_SLAVE_MODE_GATED
#define TIMER_OCMODE_PWM1                TIMER_OC_MODE_PWM1
#define TIMER_OCPOLARITY_HIGH            TIMER_OC_POLARITY_HIGH
#define TIMER_OCNPOLARITY_LOW            TIMER_OCN_POLARITY_LOW
#define OCFastMode                       OCMode
#define TIMER_OCFAST_DISABLE             TIMER_OC_FAST_DISABLE
#define TIMER_OCIDLESTATE_RESET          TIMER_OC_IDLE_STATE_RESET
#define TIMER_OCNIDLESTATE_SET           TIMER_OCN_IDLE_STATE_SET
#define TIMER_AUTOMATICOUTPUT_DISABLE    TIMER_OUTAUTO_DISABLE
