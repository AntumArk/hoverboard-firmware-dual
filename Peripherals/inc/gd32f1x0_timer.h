...
#ifndef __GD32F1X0_TIMER_H
#define __GD32F1X0_TIMER_H
...
#define  TIMER_IC_POLARITY_BOTH_EDGE              ((uint16_t)0x000A)
...
#define TIMER_DMA_BASE_ADDR_DTRSF                 ((uint16_t)0x0013)
...
/** @defgroup TIMER_OCRef_Clear 
  * @{
  */
#define TIMER_OCREF_CLEAR_ETRF                    ((uint16_t)0x0008)
#define TIMER_OCREF_CLEAR_OCREFCLR                ((uint16_t)0x0000)

/**
  * @}
  */
  
/** @defgroup TIMER_Remap 
  * @{
  */
#define TIMER14_GPIO                              ((uint16_t)0x0000)
#define TIMER14_RTC_CLK                           ((uint16_t)0x0001)
#define TIMER14_HSEDiv32                          ((uint16_t)0x0002)
#define TIMER14_MCO                               ((uint16_t)0x0003)
