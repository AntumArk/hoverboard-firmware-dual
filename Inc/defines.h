...
#define LEFT_TIM TIMER1
#define LEFT_TIMER_U CCR1
#define LEFT_TIMER_UH_PIN GPIO_PIN_8
#define LEFT_TIMER_UH_PORT GPIOA
#define LEFT_TIMER_UL_PIN GPIO_PIN_13
#define LEFT_TIMER_UL_PORT GPIOB
#define LEFT_TIMER_V CCR2
#define LEFT_TIMER_VH_PIN GPIO_PIN_9
#define LEFT_TIMER_VH_PORT GPIOA
#define LEFT_TIMER_VL_PIN GPIO_PIN_14
#define LEFT_TIMER_VL_PORT GPIOB
#define LEFT_TIMER_W CCR3
#define LEFT_TIMER_WH_PIN GPIO_PIN_10
#define LEFT_TIMER_WH_PORT GPIOA
#define LEFT_TIMER_WL_PIN GPIO_PIN_15
#define LEFT_TIMER_WL_PORT GPIOB

/*
#define RIGHT_TIM TIM1
#define RIGHT_TIMER_U CCR1
#define RIGHT_TIMER_UH_PIN GPIO_PIN_8
#define RIGHT_TIMER_UH_PORT GPIOA
#define RIGHT_TIMER_UL_PIN GPIO_PIN_13
#define RIGHT_TIMER_UL_PORT GPIOB
#define RIGHT_TIMER_V CCR2
#define RIGHT_TIMER_VH_PIN GPIO_PIN_9
#define RIGHT_TIMER_VH_PORT GPIOA
#define RIGHT_TIMER_VL_PIN GPIO_PIN_14
#define RIGHT_TIMER_VL_PORT GPIOB
#define RIGHT_TIMER_W CCR3
#define RIGHT_TIMER_WH_PIN GPIO_PIN_10
#define RIGHT_TIMER_WH_PORT GPIOA
#define RIGHT_TIMER_WL_PIN GPIO_PIN_15
#define RIGHT_TIMER_WL_PORT GPIOB
*/
...
#define LEFT_DC_CUR_PIN GPIO_PIN_6
#define LEFT_U_CUR_PIN GPIO_PIN_1
#define LEFT_V_CUR_PIN GPIO_PIN_0

#define LEFT_DC_CUR_PORT GPIOA
#define LEFT_U_CUR_PORT GPIOB
#define LEFT_V_CUR_PORT GPIOB
...
#define CHARGER_PIN GPIO_PIN_0
#define CHARGER_PORT GPIOF

#define DELAY_TIMER_FREQUENCY_US 1000000
