...
//#define MOTOR_RIGHT_SIDE
#define MOTOR_LEFT_SIDE

// ################################################################################

#define DEBUG_LED

#define DEBUG_SERIAL_USART1         // Debug on Rx & Tx pins
...
//#define ENABLE_I2C                  // not supported at this time

// ################################################################################

// ###### CONTROL VIA RC REMOTE ######
// left sensor board cable. Channel 1: steering, Channel 2: speed.
//#define CONTROL_PPM                 // use PPM-Sum as input. disable DEBUG_SERIAL_USART2! not supported at this time
...
//#define ENABLE_ANALOG_IN			  // not supported at this time
...
//#define CONTROL_NUNCHUCK            // use nunchuck as input. disable DEBUG_SERIAL_USART3!, not supported at this time
...
// outputs:
// - speedL: normal driving -1000 to 1000
...
#if defined DEBUG_SERIAL_USART1 && defined CONTROL_ADC
  #error CONTROL_ADC and DEBUG_SERIAL_USART1 not allowed.
#endif

#if defined DEBUG_SERIAL_USART1 && defined CONTROL_PPM
  #error CONTROL_PPM and DEBUG_SERIAL_USART1 not allowed.
#endif

#if defined DEBUG_SERIAL_USART1 && defined CONTROL_NUNCHUCK
  #error CONTROL_NUNCHUCK and DEBUG_SERIAL_USART1 not allowed.
#endif
